...
_PRESET_BADGE_STYLES: dict[str, tuple[str, str, str]] = {
	...
	"Custom": ("#EEF2F6", "#5B6676", "#D7DEE7"),
	"Stable": ("#DCEEE3", "#1F4D38", "#2D6A4F"),
	"Balanced": ("#DCE8F2", "#1B4566", "#2563A6"),
	"Fast": ("#F3E4C7", "#6B4710", "#B7791F"),
}
...
def _stat_tile(caption: str, field: QWidget) -> QWidget:
	...
	cap.setStyleSheet("font-size: 7.5pt; font-weight: 700; color: #93A1B2; letter-spacing: 0.4px;")
	lay.addWidget(cap)
	row = QHBoxLayout()
...
class SolverPage(QWidget):
	...
	def __init__(self) -> None:
		...
		card_timing, lay_timing = make_card("T", "#0F5C8E", "Simulasi Timing", "Pengaturan waktu dan timestep")
		...
		card_preset, lay_preset = make_card("S", "#0F5C8E", "Solver Preset & Kontrol Timestep", "Strategi adaptasi timestep")
		status_row = QHBoxLayout()
		status_row.setSpacing(10)
		status_label = QLabel("Preset Aktif")
		status_label.setStyleSheet("color: #5B6676; font-size: 9pt; font-weight: 600;")
		...
		card_newton, lay_newton = make_card("N", "#0F5C8E", "Newton & Konvergensi", "Kriteria iterasi dan toleransi")
		...
		card_damp, lay_damp = make_card("D", "#0F5C8E", "Damping & Batas Koreksi Newton", "Stabilisasi koreksi tiap iterasi")
